"""Feature extraction for hum/whistle audio classification."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Extract audio features for MLEndHWII.")
    parser.add_argument(
        "--data-dir",
        type=Path,
        default=DATASET_DIR,
    ...
    parser.add_argument(
        ...
        type=str,
        default="features",
        help="Prefix for saved feature files.",
    )
    ...
    names = feature_names(cfg)
    save_features(features, ok_paths, names, meta, args.output_dir, args.output_prefix)
